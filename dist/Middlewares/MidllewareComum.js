...
const Comum = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const idUser = req.body.userId;
    const user = yield UsuarioRepository_1.default.readById(idUser);
    if (user.length === 0) {
        return res.status(403)
            .json(Retorno_1.default.Sucesso(false, [], 'O usuário passado, não foi encontrada na base de dados'));
    }
    if (user[0].tipoUsuario === TipoUsuario_1.TipoUsuario.COMUM) {
        return next();
    }
    return res.status(403).json(Retorno_1.default.Sucesso(false, [], 'Esse usuário não tem acesso'));
});
exports.default = Comum;
//# sourceMappingURL=MidllewareComum.js.map